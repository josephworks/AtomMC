    ...
    public boolean writeNextIO() {
        ...
        synchronized (this.syncLockObject)
        {
            if (this.chunksToSave.isEmpty()) {
                ...
                TIntObjectIterator<PendingChunk> it = chunksToSave.iterator();
                it.advance();
