...
public class EnderDragonPhaseTest {
    ...
    public void testBukkitToMinecraft() {
        ...
        Assert.assertEquals("SEARCH_FOR_BREATH_ATTACK_TARGET", CraftEnderDragon.getMinecraftPhase(EnderDragon.Phase.SEARCH_FOR_BREATH_ATTACK_TARGET), PhaseList.SITTING_SCANNING); // PAIL: Rename SITTING_SCANNING
